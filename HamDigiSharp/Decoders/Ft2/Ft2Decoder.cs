...
{
    // Nsps=288, NDown=9, MinNMax=45000 (3.75 s at 12 kHz), Nfft1=1152, Nss=32,
    // tone spacing=41.67 Hz.  The decoder is input-adaptive: when RealTimeDecoder
    ...
    public Ft2Decoder()
        : base(nsps: 288, nDown: 9, nMax: 45000, nfft1: 1152) { }
